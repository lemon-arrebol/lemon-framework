...
//        QRCodeBackUtil.encode(content, (String) null, destPath, false);
//    }
//
//    /**
//     * @param content       内容
...
//        QRCodeBackUtil.encode(content, imageLogoPath, destPath, false);
//    }
//
//    /**
//     * @param content      内容
...
//        QRCodeBackUtil.encode(content, (String) null, destPath, needCompress);
//    }
//
//    /**
//     * @param content       内容
...
//        BufferedImage image = QRCodeBackUtil.createImage(content, imageLogoPath, needCompress);
//        String filePath = QRCodeBackUtil.writeFile(image, destPath);
//        return filePath;
//    }
//
//    /**
...
//        QRCodeBackUtil.encode(content, iamgeLogo, destPath, false);
//    }
//
//    /**
//     * @param content      内容
...
//        BufferedImage image = QRCodeBackUtil.createImage(content, iamgeLogo, needCompress);
//        String filePath = QRCodeBackUtil.writeFile(image, destPath);
//        return filePath;
//    }
//
...
//        QRCodeBackUtil.encode(output, content, (String) null, false);
//    }
//
//    /**
//     * @param output        输出流
...
//        BufferedImage image = QRCodeBackUtil.createImage(content, imageLogoPath,
//                needCompress);
...
//        BufferedImage image = QRCodeBackUtil.createImage(content, imageLogo, needCompress);
//        ImageIO.write(image, FORMAT_NAME, output);
//    }
//
//    /**
...
//        return QRCodeBackUtil.encodeToBytes(content, (String) null, false);
//    }
//
//    /**
//     * @param content       内容
...
//        return QRCodeBackUtil.encodeToBytes(content, imageLogoPath, false);
//    }
//
//    /**
//     * @param content       内容
...
//        BufferedImage image = QRCodeBackUtil.createImage(content, imageLogoPath, needCompress);
//
//        return QRCodeBackUtil.toByteArray(image);
//    }
//
//    /**
//     * @param content   内容
...
//        return QRCodeBackUtil.encodeToBytes(content, imageLogo, false);
//    }
//
//    /**
//     * @param content      内容
...
//        return QRCodeBackUtil.decode(new File(path));
//    }
//
//    /**
//     * @param qrcodes 二维码图片
...
//        return QRCodeBackUtil.decode(image);
//    }
//
//    /**
//     * @param file 二维码图片
...
//        QRCodeBackUtil.mkdirs(destPath);
...
//        BufferedImage bufferedImage = QRCodeBackUtil.createQRCodeImage(content);
//
...
//
//        // 插入图片
//        QRCodeBackUtil.insertLogoImage(bufferedImage, imageLogoPath, needCompress);
//        return bufferedImage;
//    }
//
//    /**
...
//
//        // 插入图片
//        QRCodeBackUtil.insertLogoImage(bufferedImage, imageLogo, needCompress);
//        return bufferedImage;
//    }
//
//    /**
...
//        }
//
//        QRCodeBackUtil.setClip(bufferedImage, 10);
//
//        return bufferedImage;
//    }
//
...
//        QRCodeBackUtil.insertLogoImage(qrcodeImage, logoImage, needCompress);
//    }
//
//    /**
//     * @param qrcodeImage  二维码图片
