...
public class RadiusDecoratorTest {
    public static void main(String[] args) throws Exception {
        ...
        String destPath = "/Users/lemon/qrCode/radius";
        ...
        qrCodeConfig.setImageRadius(imageRadius);
        ...
        AlphaDecorator alphaDecorator = new AlphaDecorator(backgroundDecorator);
        RadiusDecorator radiusDecorator = new RadiusDecorator(alphaDecorator);
        radiusDecorator.generator(qrCodeConfig);
