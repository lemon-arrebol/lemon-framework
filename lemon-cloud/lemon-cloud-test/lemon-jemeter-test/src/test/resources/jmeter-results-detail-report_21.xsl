<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:param name="dateReport"
               select="substring-after(format-dateTime(current-dateTime(),'[Y0001]/[M01]/[D01] [h01]:[m01] [P]'),']')"/>
    ...
    <xsl:template name="pageHeader">
        ...
        <table width="100%">
            <tr>
                ...
                <xsl:variable name="remaining" select="$req"/>
    ...
    <xsl:template name="pagelist">
        ...
        <table align="center" class="details" border="0" cellpadding="5" cellspacing="2" width="95%">
            ...
            <xsl:for-each select="/testResults/httpSample[not(@lb = preceding::*/@lb)]">
                <!-- 按平均时间排序 -->
                <xsl:sort select="sum(../*[@lb = current()/@lb]/@t) div count(../*[@lb = current()/@lb])"
                ...
                <tr class="page_details">
                    ...
                    <td colspan="8" bgcolor="#FF0000">
                        <div align="center">
                            ...
                            <table bordercolor="#000000" bgcolor="#2674A6" border="0" cellpadding="1" cellspacing="1"
                                   width="95%">
                                <tr>
                                    <th>Thread</th>
                                    <th>Iteration</th>
